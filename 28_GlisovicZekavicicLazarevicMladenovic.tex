...
\begin{tabular}{cc}
\hline
\multicolumn{2}{c}{Protokoli kvantne razmene ključa}                                                                                                                                                                                                                                                                               \\ \hline
"Pripremi i izmeri" tip protokola                                                                                                                                  & Protokoli zasnovani na isprepletanosti                                                                                                                        \\
\begin{tabular}[c]{@{}c@{}}Zasniva se na aspektu neodređenosti\\ kvantnih čestica i njihovog svojstva\\ da promene stanje u odnosu na drugu\\ česticu\end{tabular} & \begin{tabular}[c]{@{}c@{}}Kombinovanje više kubita kako\\ bismo otklonili mogućnost\\ zamene greške prenosa (šumova) sa\\ neovlašćenim napadom.\end{tabular} \\ \hline
\end{tabular}
\end{adjustbox}
\end{table}
